...
- Name: examples.spec.ts >> save button redirects to login for unauthenticated users
- Location: e2e\examples.spec.ts:37:5
...
Call log:
  - waiting for locator('[class*="card"]') to be visible
